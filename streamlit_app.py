...
st.write("Loaded API Key:", st.secrets["openai_api_key"])  # Debugging

client = openai.OpenAI(api_key=st.secrets["openai_api_key"])  # Set API key correctly
...
if filtered_df.empty:
    ...
    summary = response.choices[0].message.content  # Extract correctly
